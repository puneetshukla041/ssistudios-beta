...
export default function LoadingPage() {
  ...
  // --- Separate Template Handlers ---
  const handleUseTemplate = (path: string) => {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center p-4 bg-transparent text-white font-sans overflow-hidden">
      ...
      {/* --- Main Content --- */}
      <div className="w-full max-w-6xl mx-auto flex flex-col justify-start pl-8 space-y-10">
        {/* --- Certificate 2 Card --- */}
        <div
          className="
        ...
        >
          ...
          <div className="md:w-1/2 w-full text-center md:text-left">
            ...
            <p className="text-gray-700 mb-4 text-sm leading-relaxed">
              This <span className="font-semibold text-gray-900">Certificate of Excellence</span> is awarded to participants 
              who have successfully completed advanced training in the 
              <span className="text-gray-900"> SSI Mantra Surgical Robotic System</span>.  
              It recognizes outstanding performance and professional mastery in robotic-assisted surgeries.
              Provided by <span className="text-gray-900">Sudhir Srivastava Innovations Pvt. Ltd.</span>, 
              it stands as a symbol of expertise, dedication, and excellence.
            </p>

            <button
              onClick={() => handleUseTemplate("/certificate2")}
        ...
        <div
          className="
            w-full max-w-4xl bg-white/5 rounded-3xl p-8 shadow-2xl
            flex flex-col md:flex-row items-center gap-8
            backdrop-blur-lg border-4 border-white/20 hover:border-white/40 transition-all duration-300
            transform transition-all duration-1000 ease-in-out hover:scale-[1.01]
            -ml-4 md:ml-18
